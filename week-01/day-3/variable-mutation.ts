...
if (i1 > (i2*i2) && i1 < (i2*i2*i2)){
    console.log('yes, i1 is higher than i2 squared and smaller than i2 cubed');
} else {
    console.log('no, i1 is not higher than i2 squared and not smaller than i2 cubed');
}

let j: number = 1521;
// tell if j is divisible by 3 or 5 (as a boolean)
if (j % 3 === 0 || j % 5 ===0 ){
    console.log('yes, j is divisible by 3 or 5');
}